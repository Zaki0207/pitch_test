...
/**
 * The ISS_Display.XPlaneConnectDiscovery joins a UDP multi cast group and listens for BECN packets published by
 * ISS_Display.XPlaneConnect server plugin. It allows to clients to discover XPlane instances and be sure that the XPlanePlugin is
 * installed.
 */
