...
public class XPlaneConnect implements AutoCloseable {
    ...
    /**
     * Initializes a new instance of the {@code ISS_Display.XPlaneConnect} class using default ports and assuming X-Plane is running on the
     * local machine.
     *
    ...
    /**
     * Initializes a new instance of the {@code ISS_Display.XPlaneConnect} class with the specified timeout using default ports and
    ...
    /**
     * Initializes a new instance of the {@code ISS_Display.XPlaneConnect} class using the specified ports and X-Plane host.
     *
    ...
    /**
     * Initializes a new instance of the {@code ISS_Display.XPlaneConnect} class from a received discovery ISS_Display.Beacon
     *
     * @param beacon The beacon received from {@code ISS_Display.XPlaneConnectDiscovery}
    ...
    /**
     * Initializes a new instance of the {@code ISS_Display.XPlaneConnect} class using the specified ports, hostname, and timeout.
     *
     * @param xpHost  The network host on which X-Plane is running.
     * @param xpPort  The port on which the X-Plane Connect plugin is listening.
